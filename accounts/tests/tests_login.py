...
class UserProfileTests(TestCase):
    ...
    def setUp(self):
        ...
        self.user1 = UserFactory(username=self.username1, set_password=self.password1)
        self.username2 = 'testuser2'
        self.password2 = 'testpass2'
        self.user2 = UserFactory(username=self.username2, set_password=self.password2)
    ...
    def test_duplicate_public_name(self):
        ...
        self.assertFalse(is_valid, "Form should be invalid with duplicate public_name")
